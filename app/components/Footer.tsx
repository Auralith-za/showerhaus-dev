    ...
    <footer className="w-full bg-white border-t border-gray-50">
      ...
      */}
      ...
      <div className="bg-gray-50 border-t border-gray-100 py-6">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-[10px] tracking-[0.2em] text-gray-400 font-light uppercase gap-8 md:gap-0">
          <p className="order-2 md:order-1 text-center md:text-left text-gray-400 text-[10px] font-light tracking-[0.2em] uppercase">
